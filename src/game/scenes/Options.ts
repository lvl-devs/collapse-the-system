  ...
  create() {
    ...
    const slider1 = this.createHudSlider({
      ...
      onChange: (v) => {
        ...
        if (this.returnMode === "menu" && this.rainSfx) {
          this.rainSfx.setVolume(v);
        }
      },
    });
    ...
    const slider2 = this.createHudSlider({
      ...
      onChange: (v) => {
        ...
        if (this.returnMode === "menu" && this.menuMusic) {
          this.menuMusic.setVolume(MusicManager.toEngineVolume(v));
        }
      },
    });
